...
// +kubebuilder:rbac:groups=quicksight.services.k8s.aws,resources=datasources,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=quicksight.services.k8s.aws,resources=datasources/status,verbs=get;update;patch
...
func (rm *resourceManager) IsSynced(ctx context.Context, res acktypes.AWSResource) (bool, error) {
	...
	statusCandidates := []string{"CREATION_SUCCESSFUL", "UPDATE_SUCCESSFUL"}
