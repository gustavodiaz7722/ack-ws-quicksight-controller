...
const (
	FinalizerString = "finalizers.quicksight.services.k8s.aws/Analysis"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("analyses")
